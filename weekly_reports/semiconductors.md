...
### 1. The transistor was patented 75 years ago today   the age of silicon and software began with a three-electrode circuit element using semiconductor materials ⭐⭐⭐
...
💡 *The transistor's 75th patent anniversary underscores the foundational shift to silicon and software technology.*
...
### 2. Intel's upcoming Panther Lake family will reportedly feature new "Core Ultra X" branding for fully-spec'd iGPU configs ⭐⭐
...
💡 *Intel’s “Core Ultra X” branding signifies a major leap in integrated graphics performance with Panther Lake.*
...
### 3. OpenAI and AMD announce multibillion-dollar partnership ⭐⭐
...
💡 *AMD and OpenAI's partnership signifies a major leap in AI infrastructure investment.*
...
### 4. 1GHz Renesas RA8T2 Cortex-M85 MCUs feature MRAM and EtherCAT for industrial motor control ⭐⭐
...
💡 *Renesas RA8T2 MCUs offer a powerful, secure solution for advanced industrial motor control applications.*
...
### 5. Nordic nRF54LM20A Cortex-M33 wireless MCU doubles the SRAM to 512 KB, increases flash capacity ⭐⭐
...
💡 *Nordic’s nRF54LM20A expands memory and capabilities for richer wireless applications.*
...
### 6. Intel's flagship Core Ultra 9 285K is down to its lowest price ever, at just $489 ⭐⭐
...
💡 *Intel's Core Ultra 9 285K is now an unexpectedly affordable, high-performance alternative.*
...
### 7. Acer chief says Nvidia s Intel investment will complicate PC supply chains ⭐⭐

**Score:** 7/10 | Acer CEO Jason Chen believes Nvidia and Intel's partnership poses challenges for PC manufacturers' product planning and placement. He also expressed skepticism about the potential realization of a 50/50 joint venture proposal. This collaboration could significantly impact the established PC supply chain.

💡 *Nvidia-Intel’s partnership threatens PC supply chain stability and manufacturer planning.*
...
### 8. OCuLink outpaces Thunderbolt 5 in Nvidia RTX 5070 Ti tests ⭐⭐
...
💡 *OCuLink’s superior performance over Thunderbolt 5 challenges the conventional eGPU landscape.*
...
### 9. One of the fastest 2TB PCIe 5.0 SSDs is down to its lowest price ever, 8 cents per gigabyte this Prime Day   Enjoy blazing-fast PCIe 5.0 storage for only $159 ⭐⭐
...
💡 *Crucial's T705 2TB PCIe 5.0 SSD is an unbeatable Prime Day deal.*
...
### 10. AI data centers are swallowing the world’s memory and storage supply, setting the stage for a pricing apocalypse that could last a decade ⭐⭐
...
💡 *AI’s surging data needs are fueling a storage price crisis with potential long-term consequences.*

🔗 [Read More](https://www.tomshardware.com/pc-components/storage/perfect-storm-of-demand-and-supply-driving-up-storage-costs)

---

### 11. wafer.space lets you design your custom silicon just for $7 per die (Crowdfunding) ⭐⭐
...
💡 *Wafer.space democratizes custom ASIC design with ultra-low-cost silicon fabrication.*

🔗 [Read More](https://www.cnx-software.com/2025/10/07/wafer-space-lets-you-design-your-custom-silicon-just-for-7-per-die/)

---

### 12. Easily add 80+ Mbps Ethernet to microcontrollers with WIZ630io QSPI RJ45 module ⭐⭐
...
💡 *This module provides a simple way to add fast Ethernet to microcontroller projects.*
...
### 13. kv4p HT Turn an Android smartphone into a ham radio transceiver ⭐⭐
...
💡 *The kv4p HT empowers DIY ham radio enthusiasts with affordable, off-grid communication.*
...
💡 *This M5Stack card offers a powerful, compact AI accelerator for accelerating edge AI applications.*
...
**Score:** 7/10 | Qualcomm has unveiled three new 3nm Snapdragon X2 Elite processors – Extreme, Elite (88 and 80), designed for high-end Windows laptops. These processors boast powerful performance cores, advanced AI capabilities (Hexagon NPU), and cutting-edge connectivity features like WiFi 7 and PCIe Gen5. The lineup promises fastest and most efficient performance for laptops.

💡 *Qualcomm's new Snapdragon X2 Elite processors herald a potential shift in high-end Windows laptop performance and efficiency.*
...
💡 *The AAEON GENE-ARH6 delivers powerful AI processing for demanding robotics and industrial applications.*
...
### 17. ARIES MSRZG3E OSM-compliant SiP with Renesas RZ/G3E MPU targets industrial HMI and Edge AI ⭐⭐
...
💡 *This ARIES SiP delivers a powerful, OSM-compliant solution for industrial HMI and Edge AI applications.*
...
### 18. Fogwise AIRbox Q900 $599 Qualcomm IQ-9075 AI Box delivers up to 200 TOPS of AI performance ⭐⭐
...
### 19. Olimex RP2350-PICO2 open hardware boards expose all 48 GPIOs for breadboard prototyping ⭐⭐
...
### 20. Renesas RA0L1 low-cost Cortex-M23 MCUs adds capacitive, EMI-resistant touch ⭐⭐
...
💡 *Renesas RA0L1 MCU expands low-cost touch applications with integrated capacitive touch and safety features.*
...
### 21. Compex JustWiFi driverless, Ethernet-connected Wi-Fi 7 module delivers up to 10 Gbps throughput (Sponsored) ⭐⭐
...
💡 *Compex JustWiFi simplifies Wi-Fi integration with its driverless, high-speed Ethernet-connected module.*
...
### 22. Three Steam Deck-ready 2230 SSD upgrades are at record low prices 
...
💡 *Steam Deck owners can now upgrade storage at record lows for improved gaming performance.*
...
### 23. Microsoft says Xbox hardware isn't going anywhere company reaffirms commitment to AMD-powered next-gen console 
...
💡 *Microsoft’s reaffirmation ensures continued investment in its AMD-powered Xbox console strategy.*
...
### 24. One of the best 8TB SSDs is now also the cheapest at just 6 cents per GB save up to 14% on the 8TB WD Black SN850X and solve your storage needs for good 
...
💡 *The WD Black SN850X 8TB SSD offers incredible value at a remarkably low price.*
...
### 25. Developer recreates classic shoot 'em up Zaxxon as a UEFI firmware isometric arcade game coded in x86 assembly for no-OS represents 'total freedom from big tech' 
...
💡 *This project demonstrates a radical pursuit of hardware independence and control through low-level firmware development.*
...
### 26. Grab a 4TB SSD for 5 cents per gigabyte during Prime Day sales 8TB models start as low as 7 cents per GB 
...
💡 *Prime Day SSD deals offer a rare opportunity for massive storage savings.*

🔗 [Read More](https://www.tomshardware.com/pc-components/ssds/best-4tb-8tb-ssd-deals-2025)

---

### 27. Intel s Core Ultra 5 225F is at an all-time low $170, making Arrow Lake more affordable ahead of Amazon's Prime Day sale 
...
💡 *The $170 Core Ultra 5 225F unlocks the Arrow Lake platform’s potential ahead of Prime Day.*
...
### 28. Hyper 212 Pro CPU air cooler drops to an all-time low of $18 just before Prime Day   save big with a 49% discount 
...
💡 *The Hyper 212 Pro is now the most affordable CPU cooler, offering a massive discount.*
...
### 29. Ultra-rare unreleased Pentium 4 with 4.0 GHz clock speed discovered 
...
💡 *This engineering sample reveals a previously unknown, ultra-fast Pentium 4 variant, offering a fascinating look at processor development.*
...
### 30. Best MicroSD Express Cards for Nintendo Switch 2 in 2025 
...
💡 *These microSD Express cards are the best way to maximize your Nintendo Switch 2's storage and performance.*

🔗 [Read More](https://www.tomshardware.com/pc-components/microsd-cards/best-microsd-express-cards-for-nintendo-switch-2)

---

### 31. Crucial's 20Gb/s X10 Pro 2TB external SSD is only $149 in this early Amazon Prime Day deal   rugged and portable USB-C storage for tech lovers 
...
💡 *Tech enthusiasts can grab a rugged, high-capacity external SSD for a prime price.*
...
### 32. Intel N97 mini-ITX motherboard targets industrial automation, digital signage, networking appliances 
...
💡 *Intel’s N97 mini-ITX board expands options for performance-critical embedded systems.*
...
### 33. Linux 6.17 release Main changes, Arm, RISC-V, and MIPS architectures 
...
💡 *Linux 6.17’s release highlights ongoing stability improvements and driver updates across diverse architectures.*

🔗 [Read More](https://www.cnx-software.com/2025/09/29/linux-6-17-release-main-changes-arm-risc-v-and-mips-architectures/)

---

### 34. A Catalyst for Open Source: NextPCB Launches KiCad Projects Platform to Fuel the Future of KiCad (Sponsored) 
...
💡 *NextPCB’s KiCad projects platform is a significant boost for open-source electronics design innovation.*
...
### 35. Raspberry Pi CM0 castellated module features Raspberry Pi RP3A0 System-in-Package 
...
💡 *The new Raspberry Pi CM0 module expands Pi's reach with a business-focused, familiar design.*
...
### 36. Luckfox PicoKVM   A low-cost IP-KVM with 1080p HDMI capture, Wake-on-LAN, virtual storage emulation 
...
💡 *The Luckfox PicoKVM provides accessible remote PC control and development debugging capabilities.*
...
### 37. Particle Tachyon Review A Qualcomm QCM6490 Edge AI and 5G cellular SBC tested with Ubuntu 

**Score:** 5/10 | This review examines the Particle Tachyon SBC, a board based on the Qualcomm QCM6490 platform, designed for edge AI and connectivity applications. It features an octa-core CPU, 5G, Wi-Fi 6E, and Bluetooth 5.2, alongside Raspberry Pi-compatible I/O and various connectivity options. The board arrived fully packaged and ready for testing with Ubuntu.

💡 *The Particle Tachyon offers a compelling, Ubuntu-compatible edge AI platform with 5G connectivity.*
...
### 38. Amazon Prime Big Deals Day has exceptional soldering iron deals 
...
💡 *Amazon’s Big Deals Day offers significant savings on soldering iron equipment for makers and professionals.*

🔗 [Read More](https://www.tomshardware.com/maker-stem/soldering-irons/best-soldering-irons-amazon-prime-day-2025)

---

### 39. These are the tools we use to build and maintain our precious tech, and they're on sale for Amazon Prime Day 
...
💡 *Prime Day offers a chance to equip your tech and ensure its ongoing performance.*
